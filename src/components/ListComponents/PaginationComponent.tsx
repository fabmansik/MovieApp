...
const PaginationComponent = () => {
    ...
    return (
        <>
            {pathname==='/favourite'?'':<div className={'pagination'}>
                <Pagination
                    count={pathname === '/search' ? searh_total_pages : total_pages > 500 || total_pages === null ? 500 : total_pages}
                    onChange={handlePageChange} page={+querry.get('page') || 1}/>
            </div>}
        </>
    );
};
